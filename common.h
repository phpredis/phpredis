...
#define PHPREDIS_ZVAL_GET_OBJECT(class_entry, z) PHPREDIS_GET_OBJECT(class_entry, phpredis_zval_object(z))

static zend_always_inline zend_object *phpredis_zval_object(zval *zv) {
    ZEND_ASSERT(zv != NULL);
