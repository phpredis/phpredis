...
PHP_METHOD(RedisSentinel, masters)
{
    ...
    cmd_len = redis_cmd_format_static(&cmd, "SENTINEL", "s", "masters", 7);
...
PHP_METHOD(RedisSentinel, master)
{
    ...
    cmd_len = redis_cmd_format_static(&cmd, "SENTINEL", "ss", "master", 6, name, name_len);
...
PHP_METHOD(RedisSentinel, slaves)
{
    ...
    cmd_len = redis_cmd_format_static(&cmd, "SENTINEL", "ss", "slaves", 6, name, name_len);

    REDIS_PROCESS_REQUEST(redis_sock, cmd, cmd_len);
    IF_ATOMIC() {
        redis_sock_read_multibulk_reply(INTERNAL_FUNCTION_PARAM_PASSTHRU, redis_sock, NULL, ctx);
    }
    REDIS_PROCESS_RESPONSE_CLOSURE(redis_sock_read_multibulk_reply, ctx);
}
/* }}} */
...
PHP_METHOD(RedisSentinel, getMasterAddrByName)
{
    ...
    cmd_len = redis_cmd_format_static(&cmd, "SENTINEL", "ss", "get-master-addr-by-name", 23, name, name_len);
...
PHP_METHOD(RedisSentinel, reset)
{
    ...
    cmd_len = redis_cmd_format_static(&cmd, "SENTINEL", "ss", "reset", 5, name, name_len);

    REDIS_PROCESS_REQUEST(redis_sock, cmd, cmd_len);
    IF_ATOMIC() {
        redis_long_response(INTERNAL_FUNCTION_PARAM_PASSTHRU, redis_sock, NULL, ctx);
    }
    REDIS_PROCESS_RESPONSE_CLOSURE(redis_long_response, ctx);
}
/* }}} */
...
PHP_METHOD(RedisSentinel, failover)
{
    ...
    cmd_len = redis_cmd_format_static(&cmd, "SENTINEL", "ss", "failover", 8, name, name_len);

    REDIS_PROCESS_REQUEST(redis_sock, cmd, cmd_len);
    IF_ATOMIC() {
        redis_boolean_response(INTERNAL_FUNCTION_PARAM_PASSTHRU, redis_sock, NULL, ctx);
    }
    REDIS_PROCESS_RESPONSE_CLOSURE(redis_boolean_response, ctx);
}
/* }}} */
