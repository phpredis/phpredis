...
PHP_REDIS_API void redis_sock_set_client_name_zval(RedisSock *redis_sock, zval *zv);
PHP_REDIS_API int redis_sock_hello(RedisSock *redis_sock);
PHP_REDIS_API int redis_sock_set_client_info(RedisSock *redis_sock);
PHP_REDIS_API void redis_sock_free_auth(RedisSock *redis_sock);
PHP_REDIS_API void redis_sock_free_client_name(RedisSock *redis_sock);
