...
PHP_METHOD(Redis, getSet)
{
	...
	MULTI_RESPONSE("SETSET", redis_string_response);
	IF_NOT_MULTI() {
...
{	
	...
	IF_PIPELINE() {
		...
		/* 1 send the request collected */
		/* get the response, the format is related to the last request */
