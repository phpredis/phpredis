...
/* }}} */
/* {{{ proto array Redis::sUnionStore(string dst, string key0, ... string keyN)
 */
...
/* {{{ proto array Redis::sDiffStore(string dst, string key0, ... string keyN)
 */
...
/* {{{ proto variant Redis::evalsha(string sha1, [array keys, int num_key_args])
 */
