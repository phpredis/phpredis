...
ZEND_BEGIN_ARG_INFO_EX(arginfo_expireat, 0, 0, 2)
	ZEND_ARG_INFO(0, key)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_type, 0, 0, 1)
	ZEND_ARG_INFO(0, key)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_bitop, 0, 0, 2)
	ZEND_ARG_INFO(0, operation)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_hset, 0, 0, 3)
	ZEND_ARG_INFO(0, key)
	ZEND_ARG_INFO(0, hashkey)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_hget, 0, 0, 2)
	ZEND_ARG_INFO(0, key)
	ZEND_ARG_INFO(0, hashkey)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_hexists, 0, 0, 2)
	ZEND_ARG_INFO(0, key)
	ZEND_ARG_INFO(0, memberkey)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_hincrby, 0, 0, 3)
	ZEND_ARG_INFO(0, key)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_hstrlen, 0, 0, 2)
	ZEND_ARG_INFO(0, key)
	ZEND_ARG_INFO(0, field)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_blpop, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, keys, 0)
	ZEND_ARG_INFO(0, timeout)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_sdiffstore, 0, 0, 2)
	ZEND_ARG_INFO(0, dstkey)
	ZEND_ARG_VARIADIC_INFO(0, keys)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_zinter, 0, 0, 2)
	ZEND_ARG_INFO(0, key)
	ZEND_ARG_ARRAY_INFO(0, keys, 0)
	ZEND_ARG_ARRAY_INFO(0, weights, 0)
	ZEND_ARG_INFO(0, aggregate_function)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_script, 0, 0, 2)
	ZEND_ARG_INFO(0, cmd)
	ZEND_ARG_INFO(0, script)
	ZEND_ARG_ARRAY_INFO(0, scripts, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo__prefix, 0, 0, 1)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()
...
static zend_function_entry redis_functions[] = {
     ...
     PHP_ME(Redis, get, arginfo_get, ZEND_ACC_PUBLIC)
     ...
     PHP_ME(Redis, getSet, arginfo_setnx, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, randomKey, NULL, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, renameKey, arginfo_rename, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, renameNx, arginfo_rename, ZEND_ACC_PUBLIC)
     ...
     PHP_ME(Redis, incrBy, arginfo_incr, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, incrByFloat, arginfo_incr, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, decr, arginfo_incr, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, decrBy, arginfo_incr, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, type, arginfo_type, ZEND_ACC_PUBLIC)
     ...
     PHP_ME(Redis, setBit, arginfo_setrange, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, strlen, arginfo_type, ZEND_ACC_PUBLIC)
     ...
     PHP_ME(Redis, lPush, arginfo_append, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, rPush, arginfo_append, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, lPushx, arginfo_append, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, rPushx, arginfo_append, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, lPop, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, rPop, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, blPop, arginfo_blpop, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, brPop, arginfo_blpop, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, lSize, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, lRemove, arginfo_lrem, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, listTrim, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, lGet, arginfo_lindex, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, lGetRange, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, lSet, arginfo_setrange, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, lInsert, arginfo_linsert, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sAdd, arginfo_append, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sAddArray, NULL, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sSize, arginfo_append, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sRemove, arginfo_exists, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sMove, arginfo_rename, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sPop, arginfo_lindex, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sRandMember, arginfo_exists, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sContains, arginfo_del, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sMembers, arginfo_del, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sInter, arginfo_del, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sInterStore, arginfo_sdiffstore, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sUnion, arginfo_del, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sUnionStore, arginfo_sdiffstore, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sDiff, arginfo_del, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, sDiffStore, arginfo_sdiffstore, ZEND_ACC_PUBLIC)
     ...
     PHP_ME(Redis, ttl, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, pttl, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, persist, arginfo_type, ZEND_ACC_PUBLIC)
     ...
     PHP_ME(Redis, bitcount, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, bitpos, NULL, ZEND_ACC_PUBLIC)

     /* 1.1 */
     PHP_ME(Redis, mset, arginfo_mset, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, msetnx, arginfo_mset, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, rpoplpush, arginfo_rename, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, brpoplpush, arginfo_brpoplpush, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zAdd, arginfo_zadd, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zDelete, arginfo_hstrlen, ZEND_ACC_PUBLIC)
     ...
     PHP_ME(Redis, zCount, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zDeleteRangeByScore, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zDeleteRangeByRank, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zCard, arginfo_exists, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zScore, arginfo_setnx, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zRank, arginfo_hstrlen, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zRevRank, arginfo_hstrlen, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zInter, arginfo_zinter, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zUnion, arginfo_zinter, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, zIncrBy, arginfo_zincrby, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, expireAt, arginfo_expireat, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, pexpire, arginfo_expire, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, pexpireAt, arginfo_expireat, ZEND_ACC_PUBLIC)

     /* 1.2 */
     PHP_ME(Redis, hGet, arginfo_hget, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hSet, arginfo_hset, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hSetNx, arginfo_hset, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hDel, arginfo_del, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hLen, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hKeys, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hVals, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hGetAll, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hExists, arginfo_hexists, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hIncrBy, arginfo_hincrby, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hIncrByFloat, arginfo_hincrby, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hMset, arginfo_hmset, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hMget, arginfo_hmset, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, hStrLen, arginfo_hstrlen, ZEND_ACC_PUBLIC)

     PHP_ME(Redis, multi, arginfo_multi, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, discard, arginfo_multi, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, exec, arginfo_multi, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, pipeline, NULL, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, watch, arginfo_watch, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, unwatch, arginfo_watch, ZEND_ACC_PUBLIC)
     ...
     PHP_ME(Redis, evalsha, arginfo_eval, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, script, arginfo_script, ZEND_ACC_PUBLIC)

     PHP_ME(Redis, debug, NULL, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, dump, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, restore, arginfo_setex, ZEND_ACC_PUBLIC)
     ...
     PHP_ME(Redis, _prefix, arginfo__prefix, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, _serialize, arginfo__prefix, ZEND_ACC_PUBLIC)
     PHP_ME(Redis, _unserialize, arginfo__prefix, ZEND_ACC_PUBLIC)
     ...
     PHP_MALIAS(Redis, lLen, lSize, arginfo_type, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, sGetMembers, sMembers, arginfo_del, ZEND_ACC_PUBLIC)
     ...
     PHP_MALIAS(Redis, zRem, zDelete, arginfo_hstrlen, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, zRemoveRangeByScore, zDeleteRangeByScore, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, zRemRangeByScore, zDeleteRangeByScore, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, zRemRangeByRank, zDeleteRangeByRank, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, zSize, zCard, arginfo_exists, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, substr, getRange, NULL, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, rename, renameKey, arginfo_rename, ZEND_ACC_PUBLIC)
     ...
     PHP_MALIAS(Redis, ltrim, listTrim, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, lindex, lGet, arginfo_lindex, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, lrange, lGetRange, arginfo_getrange, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, scard, sSize, arginfo_append, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, srem, sRemove, arginfo_exists, ZEND_ACC_PUBLIC)
     PHP_MALIAS(Redis, sismember, sContains, arginfo_del, ZEND_ACC_PUBLIC)
